...
static int topbar           = 0;    /* -b:  whether bar is at top or bottom of screen */
...
static const char *colors[SchemeLast][2] = {
	/*                 fg         bg */
	[SchemePrompt] = { "#282828", "#ebdbb2" },
	[SchemeSlider] = { "#928374", "#282828" }, /* fg: extent labels, bg: slider beyond value */
	[SchemeValue]  = { "#a89984", "#ebdbb2" }, /* fg: value label, bg: slider up to value */
};
